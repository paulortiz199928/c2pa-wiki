...
1. **访问验证工具**：打开网页浏览器并访问 https://contentcredentials.org/verify 以使用官方 C2PA 验证工具。

2. **上传媒体文件**：将图片、视频或文档拖放到验证页面，或点击浏览并从设备中选择文件。
...
4. **验证签名状态**：确认签名显示为"有效"并带有绿色勾号，这表明内容自签名后未被篡改。
