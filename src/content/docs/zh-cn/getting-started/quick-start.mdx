...
import { quickStartHowTo } from '../../../../data/howto-quickstart-zh-cn';

<WebSiteSchema />
<BreadcrumbSchema items={[
  { name: "首页", url: "https://c2pa.wiki/zh-cn/" },
  { name: "入门指南", url: "https://c2pa.wiki/zh-cn/getting-started/quick-start/" },
  { name: "快速入门", url: "https://c2pa.wiki/zh-cn/getting-started/quick-start/" }
]} />
