...
import { quickStartHowTo } from '../../../../data/howto-quickstart-de';

<WebSiteSchema />
<BreadcrumbSchema items={[
  { name: "Startseite", url: "https://c2pa.wiki/de/" },
  { name: "Erste Schritte", url: "https://c2pa.wiki/de/getting-started/quick-start/" },
  { name: "Schnellstart", url: "https://c2pa.wiki/de/getting-started/quick-start/" }
]} />
