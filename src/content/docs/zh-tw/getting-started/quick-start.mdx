...
import { quickStartHowTo } from '../../../../data/howto-quickstart-zh-tw';

<WebSiteSchema />
<BreadcrumbSchema items={[
  { name: "首頁", url: "https://c2pa.wiki/zh-tw/" },
  { name: "入門指南", url: "https://c2pa.wiki/zh-tw/getting-started/quick-start/" },
  { name: "快速入門", url: "https://c2pa.wiki/zh-tw/getting-started/quick-start/" }
]} />
